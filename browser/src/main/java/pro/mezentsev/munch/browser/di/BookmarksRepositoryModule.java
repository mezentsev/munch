...
import pro.mezentsev.munch.bookmarks.data.local.BookmarksDao;
import pro.mezentsev.munch.bookmarks.data.local.LocalBookmarksDataSource;
...
import pro.mezentsev.munch.bookmarks.data.local.BookmarksDatabase;
